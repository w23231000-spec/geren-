...
class ModelConstants:
    ...
    KR_0: float = 5.274599
    KR_1: float = 14.8628
    KCo_0: float = 0.013083
    KCo_1: float = 0.0246588
    KL_0: float = 4.450837
    KL_1: float = 5.93653
    KG_0: float = 43.548524
    KG_1: float = 5.31479
    KCsub_0: float = 0.001107
    KCsub_1: float = 0.00100061
    KCimd1_0: float = 100.000000
    KCimd1_1: float = 99.8572
    KCimd2_0: float = 54.485220
    KCimd2_1: float = 45.6968
    KR1_0: float = 0.001204
    KR1_1: float = 0.00129773
    KL1_0: float = 0.328474
    KL1_1: float = 0.649358
    KC1_0: float = 0.635423
    KC1_1: float = 1.71876
    KR22_0: float = 0.001192
    KR22_1: float = 0.00120632
    KL22_0: float = 1.111875
    KL22_1: float = 2.20817
    KC22_0: float = 3.751297
    KC22_1: float = 7.34151
    KR3_0: float = 0.001577
    KR3_1: float = 0.00110007
    KL3_0: float = 0.180873
    KL3_1: float = 0.00129671
    KC3_0: float = 0.921156
    KC3_1: float = 0.0062678
    KC2_0: float = 6.670504
    KC2_1: float = 0.069537
    KL2_0: float = 84.865197
    KL2_1: float = 0.713236
    KRbga_0: float = 0.003030
    KRbga_1: float = 30920.6
    KLbga_0: float = 5.572294
    KLbga_1: float = 9.30123
    KCbga_0: float = 13.912922
    KCbga_1: float = 0.0127581
    KRlf_0: float = 12.944085
    KRlf_1: float = 2.00866
    KClf_0: float = 2.856840
